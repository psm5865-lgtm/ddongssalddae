...
export const STRETCH_SEQUENCE: StretchStep[] = [
  ...
  { name: '손목 돌리기', seconds: 12, instruction: '양 손목을 천천히 둥글게 돌려요' },
  { name: '발목 돌리기', seconds: 12, instruction: '한 발씩 발목을 천천히 둥글게 돌려요' },
  { name: '허리 비틀기', seconds: 14, instruction: '상체를 좌우로 천천히 비틀어요' },
  { name: '등 펴기', seconds: 15, instruction: '두 손 깍지 껴 앞으로 밀며 등을 둥글게' },
